...
function Neo4jD3(_selector, _options) {
    ...
    function appendNodeToGraph() {
        ...
        n.append('circle')
            ...
            .attr('r', 10)
            .attr('cx', function(d) {
                return icon(d) ? (parseInt(Math.round(options.nodeRadius * 0.32)) + 'px') : '15px';
            })
            .attr('cy', function(d) {
                return icon(d) ? (parseInt(Math.round(options.nodeRadius * 0.32)) + 'px') : '-15px';
            })
        
        // font-size="8px" style="color: white;" fill="#ffffff" class="mastery_prob" x="8px" y="-12px"
        n.append('text')
            .attr('class', function(d) {
                return 'mastery_prob'
            })
    ...
    function appendTextToNode(node) {
        return node.append('text')
                   ...
                   .attr('font-size', function(d) {
                       return icon(d) ? (options.nodeRadius + 'px') : '5px' // '10px';
                   })
